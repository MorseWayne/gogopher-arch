...
截至 `m1-first-slice-v20`，运行时已经发布 M1-01 至 M1-14、M2-01 至 M2-05 共十九个能力节点。M1-01 已调整为从亲手完成第一个 Go 程序开始的引导、练习、评估、复习闭环；M2 后端阶段已经从标准库 HTTP、稳定 API 契约和业务分层进入 SQL 查询资源与 schema migration：
