...
截至 `m1-first-slice-v10`，运行时已经发布 M1-01、M1-02、M1-03、M1-04、M1-05、M1-06、M1-07、M1-08、M1-09、M1-10、M1-11、M1-12、M1-13 十三个能力节点。M1-02、M1-04、M1-05、M1-06、M1-08、M1-10 与并发批次均具备完整闭环：
