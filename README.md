...
当前 `m1-first-slice-v20` 已发布 M1-01 至 M1-14、M2-01 至 M2-05。学习主链从“亲手完成第一个 Go 程序”开始，经练习、独立评估和变式复习后进入类型语义、工程能力、HTTP 服务、稳定 API 契约、显式业务分层、SQL 查询资源管理与 forward-only schema migration。
...
go run ./cmd/learning-content release \
  ...
  --release-id m1-first-slice-v20 \
  --created-at 2026-07-19T03:00:00Z
```
